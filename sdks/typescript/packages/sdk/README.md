...
The runtime is resolved from an explicit `runtimePath`, `LLAMA_HARNESS_RUNTIME_PATH`, or a matching future platform package. The SDK never downloads a binary at runtime.
