...
Execution duration and successful-result publication wait use cumulative fixed
buckets at 1, 5, 10, 25, 50, 100, 250, 500, 1,000, 2,500, and 5,000 ms, plus an
overflow count; each also reports count, saturating sum, and maximum. These
bounded aggregates are sufficient to derive P50/P95 without retaining per-call
