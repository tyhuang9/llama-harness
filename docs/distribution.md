...
`observability`, `evals`, `tauri`, `programmatic`, and default-off `mcp` are optional named
modules. These eight Rust-facing crates are the 0.1 publication set. The CLI, protocol/runtime sidecar, Promptfoo
