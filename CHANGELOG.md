...
- Stabilize named `ollama`, `observability`, `evals`, and `tauri` facade modules
  with Rust 1.88 as the verified minimum supported version.
- Define the six-crate Rust publication set and defer protocol/runtime SDK
